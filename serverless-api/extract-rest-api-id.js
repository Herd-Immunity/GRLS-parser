...
if (typeof stage === "undefined") {
  ...
  console.error(msg);
  console.error(
    `usage: aws apigateway get-rest-apis --output json | ${process.argv[1]} <stage>`
  );
  console.error(
    `   eg: aws apigateway get-rest-apis --output json | ${process.argv[1]} dev`
  );
  throw new Error(msg);
}
const targetRestApiName = stage + "-vaccination-handbook-api-app";
